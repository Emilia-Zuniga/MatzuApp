        ...
        VStack{
            ...
            ZStack{
                ...
                VStack{
                    ...
                    .padding()
                    Text("This is the first example to learn how to solve a first degree equation, it is important to analyze the signs and the order of the terms.")
                        .foregroundColor(.black)
...
struct Model2View_Previews: PreviewProvider {
    static var previews: some View {
        Model2View(isShowing: .constant (true))
    }
}
