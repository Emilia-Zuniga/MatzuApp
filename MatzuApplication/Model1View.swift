        ...
        VStack{
            ...
            ZStack{
                ...
                VStack{
                    ...
                    .padding()
                    Text("As a first step we observe that the number 4 has a positive sign (+) so when moving to the second member it must have a negative sign (-), in this way we have a subtraction.")
                        .foregroundColor(.black)
...
struct Model1View_Previews: PreviewProvider {
    static var previews: some View {
        Model1View(isShowing: .constant (true))
    }
}
