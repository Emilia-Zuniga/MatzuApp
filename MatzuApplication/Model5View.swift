        ...
        VStack{
            ...
            ZStack{
                ...
                VStack{
                    ...
                    .padding()
                    Text("Finally we write the result of the division and in this way we have found the value of X.")
                        .foregroundColor(.black)
...
struct Model5View_Previews: PreviewProvider {
    static var previews: some View {
        Model5View(isShowing: .constant (true))
    }
}
